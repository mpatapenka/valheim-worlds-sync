...
3. Скачать и установить Git <https://git-scm.com/downloads>. На всякий случай выполнить команды в CMD:
    - git config --global user.email "your@mail.com"
    - git config --global user.name "ник на гитхабе"
...
Далее открыть CMD в этой папке и обновить локальный репозиторий с мирами:
   ...
   Следом найти файл *.gitignore* и добавить в него шаблон имени мира в формате )_!GACHIMUCHI.*_. Именование мира чувствительно к регистру! Далее в открытом CMD выполнить команды:
